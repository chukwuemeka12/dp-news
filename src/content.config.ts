...
const articleCollection = defineCollection({
	...
	schema: z.object({
		...
		sourceDetailUrl: z.string().url().nullable().optional(),
		...
		localDocumentUrl: z.string().nullable().optional(),
		documentContentType: z.string().nullable().optional(),
		documentSizeBytes: z.number().nullable().optional(),
		documentSha256: z.string().nullable().optional(),
		documentDownloadedAt: z.string().nullable().optional(),
		documentDownloadError: z.string().nullable().optional(),
